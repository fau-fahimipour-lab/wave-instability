## Packages
using LinearAlgebra, StatsBase, Distributions, DataFrames, IterTools, EcologicalNetworks, Tidier, ColorSchemes, Plots
...
## JIT
## ---
sweep([5], [0.3], [0.2], [0.25], 1, "Constrained", "Niche")


## ------------------
## Take it for a spin
## ------------------
@time dat = sweep(10:5:35, [0.25], [0.25], 0:0.1:1, 200, "Constrained", "Niche")
...
savefig("~/Desktop/nicheConstrained.png")
